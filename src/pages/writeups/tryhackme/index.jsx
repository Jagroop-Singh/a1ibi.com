  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="A collection of TryHackMe writeups utilizing a variety of tools and techniques. Some challenges involve creating tools in various programming languages."
        />
      </Head>
      <SimpleLayout
        title="Taking on TryHackMe challenges"
        intro="A collection of TryHackMe writeups utilizing a variety of tools and techniques. Some challenges involve creating tools in various programming languages."
      >
...
export async function getStaticProps() {
  return {
    props: {
      writeups: (await getAllWriteups("tryhackme")).map(({ component, ...meta }) => meta),
    },
  }
}
