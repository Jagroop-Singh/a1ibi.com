...
export const meta = {
  ...
  date: '2023-02-09',
  title: 'C vs Rust: Secure Programming',
  description:
    "Several embedded systems and IOT devices use C. It comes with powerful capabilities, able to control pointers and runs till it crashes with a segfault. It's very easy to miss details in C, and unlike Rust, it won't warn you.",
}
